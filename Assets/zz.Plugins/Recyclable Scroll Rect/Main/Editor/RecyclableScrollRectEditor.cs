...
namespace PolyAndCode.UI
{
    ...
    public class RecyclableScrollRectEditor : Editor
    {
		...
		SerializedProperty _cellPadding;
        ...
        protected virtual void OnEnable()
        {
			...
			_cellPadding = serializedObject.FindProperty( "_cellPadding" );
        ...
        public override void OnInspectorGUI()
        {
			...
			EditorGUILayout.PropertyField( _cellPadding, new GUIContent( "Cell Padding" ) );
